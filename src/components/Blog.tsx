export default function Blog() {
  return (
    <section className="bg-gray-100 py-6 text-gray-800 sm:py-12">
          ...
          <article className="flex flex-col bg-gray-50">
            ...
            <div className="flex flex-1 flex-col p-6">
              ...
              <a
                rel="noopener noreferrer"
                href="#"
                className="text-xs uppercase tracking-wider text-cyan-600 hover:underline"
              >
                Convenire
              </a>
              ...
              <div className="flex flex-wrap justify-between space-x-2 pt-3 text-xs text-gray-600">
